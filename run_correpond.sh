...
#SBATCH --error=logdir/log.correspond.%A.err
#SBATCH --output=logdir/log.correspond.%A.out
#SBATCH --job-name="correspond"
...
echo "Starting correspondence process"
srun uv run python -m src.preprocess.check_correspondance
